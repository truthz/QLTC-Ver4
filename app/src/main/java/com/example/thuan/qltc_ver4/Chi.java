...
public class Chi extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        XN = (Button) findViewById(R.id.btnXN_Chi);
        cancel = (Button) findViewById(R.id.btnCancel_Chi);
        Sotien = (EditText) findViewById(R.id.etSoTien_Chi);
        BenT2 = (EditText) findViewById(R.id.etBent2_Chi);
        Ngay = (EditText) findViewById(R.id.etdate_Chi);
        Date date = new Date();
        SimpleDateFormat dinhDangThoiGian = new SimpleDateFormat("dd/MM/yyyy ");
        Ngay.setText( dinhDangThoiGian.format(date.getTime()));
        TK = (EditText) findViewById(R.id.etTK_Chi);
        ...
        XN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!Sotien.getText().toString().equals("") &&
                    ...
                    databaseHelper.GiaoDIch(sID, sUserID, sBenT2, sTenTK, "Chi", sotien, sDate);
                    databaseHelper.update_TK(sTenTK, databaseHelper.gettong_TK(sTenTK) - sotien);
                    final Intent i = new Intent(Chi.this, MainMenu.class);

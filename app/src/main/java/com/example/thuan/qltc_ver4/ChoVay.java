 ...
 */
public class ChoVay extends Activity {
    Button XN,cancel;
    EditText Sotien,BenT2,Ngay,TK;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        this.setContentView(R.layout.chovay);
        XN = (Button) findViewById(R.id.btnXN_ChoVay);
        cancel = (Button) findViewById(R.id.btnCancel_ChoVay);
        Sotien = (EditText) findViewById(R.id.etSoTien_ChoVay);
        BenT2 = (EditText) findViewById(R.id.etBent2_ChoVay);
        Ngay = (EditText) findViewById(R.id.etdate_ChoVay);
        Date date = new Date();
        SimpleDateFormat dinhDangThoiGian = new SimpleDateFormat("dd/MM/yyyy ");
        Ngay.setText( dinhDangThoiGian.format(date.getTime()));
        TK = (EditText) findViewById(R.id.etTK_ChoVay);
        ...
        XN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!Sotien.getText().toString().equals("")&&
                    ...
                    databaseHelper.GiaoDIch(sID,sUserID,sBenT2,sTenTK,"ChoVay",sotien,sDate);
                    databaseHelper.update_TK(sTenTK, databaseHelper.gettong_TK(sTenTK) - sotien);
                    final Intent i = new Intent(ChoVay.this, Vay.class);
